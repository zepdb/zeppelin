...
pub(crate) const IDEAL_CASES: &[IdealCase] = &[
    ...
    frozen("secured_filtered_query", IdealCaseGroup::Query),
    ...
    ideal_case(
        "lease.renew_etag_drift",
        IdealCaseGroup::Lease,
        IdealOperation::Lease(LeaseCase::RenewEtagDrift),
    ),
    ideal_case(
        "lease.renew_double_conflict",
        IdealCaseGroup::Lease,
        IdealOperation::Lease(LeaseCase::RenewDoubleConflict),
    ),
    ideal_case(
        "lease.renew_missing",
        IdealCaseGroup::Lease,
        IdealOperation::Lease(LeaseCase::RenewMissing),
    ),
    ideal_case(
        "lease.renew_cold",
        IdealCaseGroup::Lease,
        IdealOperation::Lease(LeaseCase::RenewCold),
    ),
    ideal_case(
        "lease.renew_put_etag_missing",
        IdealCaseGroup::Lease,
        IdealOperation::Lease(LeaseCase::RenewPutEtagMissing),
    ),
    ideal_case(
        "lease.renew_taken_over",
        IdealCaseGroup::Lease,
        IdealOperation::Lease(LeaseCase::RenewTakenOver),
    ),
    ideal_case(
        "lease.release_owned",
        IdealCaseGroup::Lease,
