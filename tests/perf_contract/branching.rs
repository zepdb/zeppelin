...
//
//   <dst>/meta.json                         7  creating-intent probes, one
//     metadata-transition CAS read, publication reads, activation loops.
//     Was 9: both the rooting CAS and the publish CAS return the intent they
//     install, so each seeds the next step instead of reading the object back
...
const MAX_FORK_CONTROL_GETS: u64 = 33;
